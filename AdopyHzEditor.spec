...
binaries = []
hiddenimports = ['PySide6.QtCore', 'PySide6.QtGui', 'PySide6.QtWidgets', 'ssl', '_ssl']
...
a = Analysis(
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['PySide6.QtQml', 'PySide6.QtQuick', 'PySide6.QtQuickWidgets', 'PySide6.QtQuickControls2'],
    noarchive=False,
    optimize=0,
)
pyz = PYZ(a.pure)
