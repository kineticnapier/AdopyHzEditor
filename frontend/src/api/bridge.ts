export type EditorSettings = {
  ...
  spectrumThreshold: number; spectrumOpacity: number;
...
export type BackendApi = {
  ...
  open_audio(): Promise<AppState>; reanalyze_audio(): Promise<AppState>; get_spectrogram(maxColumns?: number): Promise<SpectrogramPayload>; get_spectrum_region(startTime: number, endTime: number, minMidi: number, maxMidi: number, pixelWidth: number, pixelHeight: number, threshold?: number): Promise<DirectSpectrumPayload>; get_cursor_peak(seconds: number, midi: number, searchRange?: number): Promise<CursorPeakPayload>;
